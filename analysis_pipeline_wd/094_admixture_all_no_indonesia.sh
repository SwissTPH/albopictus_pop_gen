#!/bin/bash
#SBATCH --job-name=094_admixture_all_no_indonesia
#SBATCH --mem=10G
#SBATCH --cpus-per-task=16
#SBATCH --time=02:00:00 
#SBATCH --qos=6hours
#SBATCH --output=logs/094_admixture_all_no_indonesia.%a.out
#SBATCH --error=logs/094_admixture_all_no_indonesia.%a.err
