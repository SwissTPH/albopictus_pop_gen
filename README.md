# albopictus_pop_gen
This repository contains a ddRAD-seq analysis pipeline for <i>Aedes albopictus</i>. The workflow was developed to process paired-end ddRAD-seq data generated from libraries prepared with the NlaIII and MluCl restriction enzymes. The scripts are numbered according to the order in which they should be run and should generally be executed sequentially.
